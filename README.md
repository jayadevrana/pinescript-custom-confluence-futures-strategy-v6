...
# Custom Confluence Futures Strategy v6

A public TradingView Pine Script strategy project published by Jayadev Rana for traders and developers studying EMA, RSI, MACD.

## Overview

This repository contains a Pine Script source file saved as `pinescript_custom_confluence_futures_strategy_v6.txt` so it opens easily on GitHub and can be copied into TradingView.

The script focuses on EMA, RSI, MACD, Supertrend, ATR, ADX. It is useful for TradingView chart study, Pine Script learning, technical-analysis research, alerts, and strategy development workflows.

For custom TradingView Pine Script development, visit https://jayadevrana.com.

## Strategy Description

Custom Confluence Futures Strategy v6 gives traders a practical chart workflow around EMA, RSI, MACD, Supertrend. The source is kept readable in a single `.txt` file so the logic can be reviewed, copied, and adapted inside TradingView.
...
3. Copy the code from `pinescript_custom_confluence_futures_strategy_v6.txt`.
